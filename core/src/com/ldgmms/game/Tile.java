...
public class Tile implements TiledMapTile {
     ...
     */
    public Tile(TileType type, Tile neighbor[]) { // TODO: constructor should probably have more properties than just its neighbors - also may wish to use a class instead of an array?
        this.type = type;
